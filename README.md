...
While the standards are relatively simple implementation-wise
as it is just a JSON
wrapped in gzip compression and base64 encoding with a header,
it can be helpful to have a client library
which provides certain types and utilities
for easier creation and handling of medication plans.
...
If you have implemented a client library in a cerain language
